...
$(function () {
    ...
    agregarEventoCheckboxRadio(['chkCiudad', 'chkEducacion']);
...
function mostrarPublicaciones() {
    ...
    $.ajax({
            url: "includes/buscarTrabajador.php"+location.search,
            type: "GET",
        }).done(function(respuesta){
            console.log(respuesta);
            let publicaciones = JSON.parse(respuesta);
            publicar(publicaciones, "#trabajadores");
...
<div class="card card-body mb-2 container shadow-lg  bg-white rounded text-center">
    <div class="row">
        ...
        <div class="col-12 col-md-9 text-md-left">           
            ...
            <br> <strong>Pais:</strong> ${publicaciones.paisnombre} 
...
function mostrarPagina(){
    ...
    if(paginas > 1){
            ...
            <nav aria-label="Page navigation example">
					...
					<li class="page-item ${siguiente}">
      					<a class="page-link" href="buscarTrabajador.php?pagina=${paginaActual- 1}" aria-label="Previous">
					...
					<li class="page-item ${anterior}">
      					<a class="page-link" href="buscarTrabajador.php?pagina=${paginaActual + 1}" aria-label="Next">
    ...
    function obtenerListaPagina(paginas){
        ...
        for(let i=1 ;i <= paginas; i++) { 
            ...
            liPagina.push(`<li class="page-item ${desactivar}"><a class="page-link" href="buscarTrabajador.php?pagina=${i}">${i}</a></li>`);
        }
...
function buscarJSON(json){
    ...
    let ajax = $.ajax({
        url: 'includes/buscarTrabajador.php?busqueda=true',
        type: 'GET',
        data: {datos: json}
    })
    ...
    ajax.done(function(respuesta){
        ...
        history.pushState(null, "", "buscarTrabajador.php?pagina=1");
        let publicaciones = JSON.parse(respuesta);
        publicar(publicaciones, "#trabajadores");
    });
