...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2019 at 06:14 PM
...
(6, 'smartprocess', 'Empresa de Ingenieria dedicada a realizar var', 'j-123123', 'tierra negra', 'IngenierÃ­a', 'sp@smartprocessgroup.com', 'www.sp.com', '1234'),
...
(9, 'smartproces', 'vzla', 'ingenieria', 'logistica', 'coordinar embarques', '2019-07-15 00:00:00', '2019-10-31 00:00:00', 6),
(10, 'sad', 'sda', 'dadad', 'sd', 'd', '0000-00-00 00:00:00', '0123-03-12 00:00:00', 6);
...
(40, 'DESARROLLADOR WEB BACK END', 'QUE SEPA MYSQL', 1, 400, 'Maracaibo', '0000-00-00 00:00:00', 6, 19, 'CREAR BASE DE DATOS');
...
(1, 'Yohesky', 'Pimentel', 268785655, 'yoheskyjpp@gmail.com', '1234', '0000-00-00 00:00:00', '', '', 2147483647, 'venezuela', 'maracaibo', 'Venezuela', 'programador', 'Universitario', '', 'ingles', 'intermedio ', '', '', NULL, 'EEE', '', '', '', '', '0000-00-00', '0000-00-00', './curriculum/CVYOHESKY2019.pdf', 'conocimientos en html,css,javascript'),
(3, 'jose', 'aljuria', 2555555, 'josealjuria@gmail.com', 'jose', '0000-00-00 00:00:00', '', '', 2147483647, 'venezuela', 'Maracaibo', 'Venezuela', 'PROGRAMADOR WEB', 'bachiller', '', 'ingles', 'intermedio', '', '', NULL, '', '', '', '', '', '0000-00-00', '0000-00-00', NULL, NULL),
(4, 'luis', 'colmenarez', 2512345, 'luis@gmail.com', 'luis', '0000-00-00 00:00:00', '', '', 2147483647, 'venezuela zulia', 'Maracaibo', 'Venezuela', 'tecnico', 'bachiller', '', 'ingles', 'basico', '', '', NULL, '', '', '', '', '', '0000-00-00', '0000-00-00', NULL, NULL),
(5, '', '', 0, '', '', '0000-00-00 00:00:00', '', '', 0, '', '', '', '', '', '', '', '', '', '', NULL, 'elinca', 'vzla', 'contratista', 'it', 'instalar computadoras', '0001-11-11', '0011-11-11', NULL, NULL),
(6, 'coral', 'portillo', 14901511, 'cportillo78@hotmail.com', '12345', '0000-00-00 00:00:00', '', '', 2147483647, 'maracaibo', 'soler', 'zulia', 'logistica', 'tsu', '', 'ingles', 'avanzado', '', '', NULL, '', '', '', '', '', '0000-00-00', '0000-00-00', './curriculum/CVYOHESKY2019.pdf', 'super intelignete');
...
--
ALTER TABLE `experiencia`
  MODIFY `idexp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `propuesta`
--
ALTER TABLE `propuesta`
  MODIFY `idpropuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
